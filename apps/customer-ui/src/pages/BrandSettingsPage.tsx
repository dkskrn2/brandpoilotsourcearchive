        ...
        <div className="panel-body">
          {brandIntelligence?.effectiveResult ? (
            <dl className="brand-intelligence-summary">
              ...
              <div><dt>차별점</dt><dd>{Array.isArray(brandIntelligence.effectiveResult.differentiators)
                ? brandIntelligence.effectiveResult.differentiators.join(" · ")
                : brandIntelligence.effectiveResult.differentiators}</dd></div>
