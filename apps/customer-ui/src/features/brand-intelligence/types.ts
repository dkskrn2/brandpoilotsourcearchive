...
export interface BrandIntelligenceGateway {
  ...
  uploadFile(brandId: string, analysisId: string, uploadId: string, file: File): Promise<string>;
  ...
  confirm(brandId: string, analysisId: string, companyName: string): Promise<BrandAnalysis>;
}
