...
alter table public.ai_content_proposal_job_contracts
  add constraint ai_content_proposal_job_contracts_versions_v3_check
  check (
...
alter table public.ai_content_proposal_job_contracts
  validate constraint ai_content_proposal_job_contracts_versions_v3_check;

alter table public.ai_content_proposal_job_contracts
  drop constraint ai_content_proposal_job_contracts_versions_check;

alter table public.ai_content_proposal_job_contracts
  rename constraint ai_content_proposal_job_contracts_versions_v3_check
  to ai_content_proposal_job_contracts_versions_check;

alter table public.ai_content_generation_prompt_bindings
  add constraint ai_content_generation_prompt_bindings_proposal_lineage_check
  check (
    (
      proposal_prompt_version = 'proposal.writer.v2'
...
alter table public.ai_content_generation_prompt_bindings
  validate constraint ai_content_generation_prompt_bindings_proposal_lineage_check;

alter table public.ai_content_generation_prompt_bindings
  drop constraint ai_content_generation_prompt_bind_proposal_prompt_version_check,
  drop constraint ai_content_generation_prompt_binding_contract_source_hash_check;
