...
alter table public.ai_content_proposal_job_contracts
  add constraint ai_content_proposal_job_contracts_versions_v5_check
  check (
...
alter table public.ai_content_proposal_job_contracts drop constraint ai_content_proposal_job_contracts_versions_check;
alter table public.ai_content_proposal_job_contracts rename constraint ai_content_proposal_job_contracts_versions_v5_check to ai_content_proposal_job_contracts_versions_check;

alter table public.ai_content_generation_prompt_bindings
  add constraint ai_content_generation_prompt_bindings_proposal_lineage_v5_check
  check (
...
alter table public.ai_content_generation_prompt_bindings rename constraint ai_content_generation_prompt_bindings_proposal_lineage_v5_check to ai_content_generation_prompt_bindings_proposal_lineage_check;
