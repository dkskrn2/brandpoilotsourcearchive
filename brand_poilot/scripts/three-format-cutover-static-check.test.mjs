...
const baseline = Object.freeze({
  ...
  "workers/brand-pilot-image-worker/src/aiContentVisualSessionPromptCompiler.ts": `import { parseContentGenerationInputV3 } from "@brand-pilot/content-contracts";`,
  "workers/brand-pilot-image-worker/src/aiContentRenderClient.ts": `import { parseContentGenerationInputV3 } from "@brand-pilot/content-contracts";`,
